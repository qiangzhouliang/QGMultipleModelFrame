 ...
 */
abstract class BasListActivity<RESPONSE,ITEMBEAN,ITEMVIEW:View> : BaseActivity(),
    BaseListView<RESPONSE> {
    /**
     * 数据操作层懒加载初始化
     */
    ...
    override fun initListener() {
        ...
        if (isAddItemDecoration){
            recycleView.addItemDecoration(RecycleViewDivider(this, LinearLayoutManager.VERTICAL))
        }
