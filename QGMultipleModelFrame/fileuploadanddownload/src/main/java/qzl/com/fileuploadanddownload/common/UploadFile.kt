...
object UploadFile {
    ...
    private fun upload(params: RequestParams, context: Context, busId: String, table: String, fileType: String, fileSource: String) {
        ...
        params.addQueryStringParameter("areaCode", SysAccount.getUserInfo(context)?.areaCode)
        ...
        params.addQueryStringParameter("userAcctId", SysAccount.getUserInfo(context)?.userAcctId)
        params.addQueryStringParameter("loginAccount", SysAccount.getUserInfo(context)?.loginAccount)
